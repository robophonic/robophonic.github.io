...
class ZohoClient
{
	...
	public function mapEntity(Element $entity)
	{
		...
		foreach ($properties as $property)
		{
			...
			if(!empty($propValue)) {
				//Except List
				if (($this->module == 'Potentials' && $propName == 'Course_ID')
					|| ($this->module == 'Potentials' && $propName == 'Number_of_Button')
					|| ($this->module == 'Potentials' && $propName == 'utm_source')
					|| ($this->module == 'Potentials' && $propName == 'utm_content')
					|| ($this->module == 'Potentials' && $propName == 'utm_medium')
					|| ($this->module == 'Potentials' && $propName == 'utm_term')
					|| ($this->module == 'Potentials' && $propName == 'user_agent')
					|| ($this->module == 'Potentials' && $propName == 'utm_campaign')
					|| ($this->module == 'Potentials' && $propName == 'click_id')
					|| ($this->module == 'Potentials' && $propName == 'google_id')
					|| ($this->module == 'Potentials' && $propName == 'ip')
					|| ($this->module == 'Potentials' && $propName == 'affiliate_id')
					|| ($this->module == 'CustomModule3' && $propName == 'Product_ID')
					|| ($this->module == 'CustomModule3' && $propName == 'Potential_ID')) {
					$xml .= '<FL val="' . str_replace(['N36', 'E5F', '&', '98T'], ['$', '_', 'and', '?'], $propName) . '"><![CDATA[' . $propValue . ']]></FL>';
				} else {
